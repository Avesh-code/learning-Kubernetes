...
---
please Keep the netwrok and subnet same for mater and worker node . and open the pots below.  

### Open Ports on Kubernetes Cluster VMs NSG in Azure

### Control Plane VM Network Security Group (NSG)

- Go to the Networking section of the VM in Azure Portal.
- Select the associated Network Security Group.
- Add inbound rules for the following ports:
  - **TCP 6443** - Kubernetes API Server
  - **TCP 2379-2380** - etcd communication
  - **TCP 10250** - kubelet
  - **TCP 10251** - scheduler
  - **TCP 10252** - controller-manager

### Worker Node Network Security Group (NSG)
